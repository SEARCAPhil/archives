  ...
  class MYPDF extends TCPDF {
    ...
    public function Header() {
      ...
      $header = '<img src="'.base_url().'assets/images/SEARCA.png" height="40">
		 <div align="center"><b>Search Report</b>
		 <br>
		 <font size="7">Document Management System</font><br/>
		 <font size="7"><b>Page '.($items_header['current_page']<=0?1:$items_header['current_page']).' of '.$items_header['pages'].'</b></font>
		 </div>
		 <hr>';
	...
	$footer = '<table style="font-size:10px;">
		     ...
		     <tr>
		       <td colspan="2" align="center">Search Report<br>SEAMEO SEARCA</td>
		     </tr>
		   </table>';

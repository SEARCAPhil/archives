<div class="col col-md-7 col-sm-9 col-md-offset-1">
	...
	<div class="col col-xs-12">
		<br/><br/><br/>
		<h3><span class="glyphicon glyphicon-cloud-upload"></span> Step 2/2  <span class="text-muted">(File Upload)</span> <span class="pull-right"> <button class="btn btn-success" onclick="window.location='<?php echo base_url().'form/success'; ?>';" id="skip">Skip &raquo;</button></span></h3>

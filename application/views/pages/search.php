			...
			<div class="well-custom" id="item<?php echo $items['data'][$x]->id; ?>">
				...
				<h4>
					<a href="?item_id=<?php echo $items['data'][$x]->id; ?>&title=<?php echo $items['data'][$x]->document_title; ?>&id=<?php echo @$items['data'][$x]->cat_id; ?>">
						...
						<?php echo ucfirst(str_ireplace(trim($search_param),'<mark>'.ucfirst($search_param).'</mark>',$items['data'][$x]->document_title)); ?>
					</a>
				...
				<p class="display-description  display-field"><?php echo ucfirst(str_ireplace(trim($search_param),'<mark>'.ucfirst($search_param).'</mark>',$items['data'][$x]->content_description)); ?></p>
